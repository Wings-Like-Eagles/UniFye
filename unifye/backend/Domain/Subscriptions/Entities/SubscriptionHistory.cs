// =============================================================================
// UniFye.Domain — SubscriptionHistory Entity
// File: Domain/Subscriptions/Entities/SubscriptionHistory.cs
// Maps to PostgreSQL: subscription_history table
// Append-only audit log — never deleted or updated.
// =============================================================================
