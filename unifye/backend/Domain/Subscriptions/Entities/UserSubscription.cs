// =============================================================================
// UniFye.Domain — UserSubscription Entity
// File: Domain/Subscriptions/Entities/UserSubscription.cs
// Maps to PostgreSQL: user_subscriptions table
// One row per user — represents their CURRENT subscription state.
// =============================================================================
