...
class _$LoginStateImpl extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, isLoading: $isLoading, obscurePassword: $obscurePassword, emailError: $emailError, passwordError: $passwordError, generalError: $generalError)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, isLoading,
      obscurePassword, emailError, passwordError, generalError);
...
abstract class _LoginState extends LoginState {
  const factory _LoginState(
      ...
      final String? emailError,
      final String? passwordError,
      final String? generalError}) = _$LoginStateImpl;
